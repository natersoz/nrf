...
def main():
    ...
    print('Advertising Interval     = {:.0f} msec'.
          format(BEACON_ADVERTISING_INTERVAL * 1000))
    print('Link Layer Packet Length = {} bytes, {} bits'.
          format(LINK_LAYER_PACKET_LENGTH, LINK_LAYER_PACKET_LENGTH*8))
    print('Link Layer Packet Period = {:.0f} usec'.
          format(LINK_LAYER_PACKET_PERIOD * 1.0E6))
    ...
    lamb = (LINK_LAYER_PACKET_PERIOD + SOFTWARE_LATENCY) / (
        BEACON_ADVERTISING_INTERVAL / BEACON_COUNT)
