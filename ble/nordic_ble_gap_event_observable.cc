 ...
 */
static ble::gap::security::pairing_failure auth_status_to_pairing_failure(
    uint8_t auth_status)
{
    ...
    logger::instance().warn(
        "unhandled nordic::auth_status_to_pairing_failure(%u)", auth_status);
    return ble::gap::security::pairing_failure::failure_unknown;
}

void ble_gap_event_notify(
    ble::gap::event_observer&       observer,
    enum BLE_GAP_EVTS               event_type,
    ble_gap_evt_t const&            event_data)
{
    ...
    case BLE_GAP_EVT_DISCONNECTED:
        {
            ...
            observer.disconnect(
                event_data.conn_handle,
                static_cast<ble::hci::error_code>(
                    event_data.params.disconnected.reason));
        }
        break;

    case BLE_GAP_EVT_CONN_PARAM_UPDATE:
        // The connection interval, slave latency, supervision timeout
        // have been updated.
        {
            ...
            logger::instance().debug(
                "GAP connection params update: h: 0x%04x, interval:"
                " (%u, %u), latency: %u, sup_timeout: %u",
                event_data.conn_handle,
                conn_params.interval_min, conn_params.interval_max,
                conn_params.slave_latency, conn_params.supervision_timeout);

            observer.connection_parameter_update(
                event_data.conn_handle,
                conn_params);
        }
        break;
    ...
    case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
        ...
        {
            ble_gap_sec_params_t const &sec_params =
                event_data.params.sec_params_request.peer_params;
            ...
            logger::instance().debug("GAP secutiry pairing request: h: 0x%04x",
                                     event_data.conn_handle);
            logger::instance().debug("io_caps: 0x%04x, oob: %u",
                                     pairing_request.io_caps,
                                     pairing_request.oob);
            ...
            observer.security_pairing_request(
                event_data.conn_handle,
    ...
    case BLE_GAP_EVT_SEC_INFO_REQUEST:
        ...
        /// @todo Nordic specific: Reply with sd_ble_gap_sec_info_reply.
        {
            ...
            logger::instance().debug("GAP secutiry info request: h: 0x%04x",
                                     event_data.conn_handle);
            logger::instance().debug("key dist: enc: %u, id: %u, sign: %u, link: %u",
                                     key_dist.enc_key,  key_dist.id_key,
                                     key_dist.sign_key, key_dist.link_key);

            observer.security_information_request(
                event_data.conn_handle,
                key_dist,
                master_id,
                peer_address);
    ...
    case BLE_GAP_EVT_PASSKEY_DISPLAY:
        ...
        /// @todo Nordic specific: reply with sd_ble_gap_auth_key_reply
        {
            ...
            observer.security_passkey_display(
                event_data.conn_handle,
                pass_key,
    ...
    case BLE_GAP_EVT_AUTH_KEY_REQUEST:
        {
            ...
            observer.security_authentication_key_request(
                event_data.conn_handle,
                event_data.params.auth_key_request.key_type);
        }
        break;
    ...
    case BLE_GAP_EVT_LESC_DHKEY_REQUEST:
        {
            ...
            observer.security_DH_key_calculation_request(
                event_data.conn_handle,
                public_key,
    ...
    case BLE_GAP_EVT_AUTH_STATUS:
        {
            ...
            observer.security_authentication_status(
                event_data.conn_handle,
                pairing_status,
    ...
    case BLE_GAP_EVT_CONN_SEC_UPDATE:
        {
            ...
            observer.connection_security_update(
                event_data.conn_handle,
                event_data.params.conn_sec_update.conn_sec.sec_mode.sm,
                event_data.params.conn_sec_update.conn_sec.sec_mode.lv,
                event_data.params.conn_sec_update.conn_sec.encr_key_size);
    ...
    case BLE_GAP_EVT_CONN_PARAM_UPDATE_REQUEST:
        {
            ...
            observer.connection_parameter_update_request(
                event_data.conn_handle,
                conn_params);
        }
        break;
    ...
    case BLE_GAP_EVT_DATA_LENGTH_UPDATE_REQUEST:
        /// @todo Nordic specific: reply with sd_ble_gap_data_length_update
        {
            ...
            observer.link_layer_update_request(
                event_data.conn_handle,
                event_data.params.data_length_update_request.peer_params.max_rx_octets,
                event_data.params.data_length_update_request.peer_params.max_rx_time_us,
                event_data.params.data_length_update_request.peer_params.max_tx_octets,
