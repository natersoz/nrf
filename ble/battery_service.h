...
{
    virtual ~battery_service() override;
     ...
     *
     * @param attr_type Determines whether the battery service
    ...
    public:
        ...
        att::signed_length_t write(void const *data, att::length_t length, att::length_t offset=0u) override;
        att::signed_length_t read(void *data, att::length_t length, att::length_t offset=0u) override;
