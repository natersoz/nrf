...
public:
     ...
     * @param conection_handle  The associated connection handle.
     ...
     */
    virtual void memory_request(uint16_t        conection_handle,
     ...
     */
    virtual void memory_release(uint16_t        conection_handle,
                                memory_type     memory_type,
                                void*           memory_address,
