...
class ble_gap_observer: public ble::gap::event_observer
{
public:
    /// inherit base class ctors.
    using ble::gap::event_observer::event_observer;
     ...
     */
    void timeout_expiration(uint16_t conection_handle,
                            ble::gap::timeout_reason reason) override {};
    /**
     ...
     *                      matched.
     */
    void security_passkey_display(uint16_t conection_handle,
     ...
     */
    void security_parameters_request(
        uint16_t conection_handle,
        bool bonding,
        ble::gap::security::pairing_request const &pair_req) override {};
     ...
     */
    void security_key_pressed(uint16_t conection_handle,
                              ble::gap::security::passkey_event
    ...
    void security_information_request(
        ...
        ble::gap::address const &peer_address) override {};
    ...
    void security_authentication_status(
        ...
        bool is_bonded, uint8_t sec_mode_1_levels,
        uint8_t sec_mode_2_levels,
        ble::gap::security::key_distribution const &kdist_own,
        ble::gap::security::key_distribution const &kdist_peer) override {};
     ...
     * 2: OOB
     */
    void security_authentication_key_request(uint16_t conection_handle,
     ...
     */
    void scan_report_request(uint16_t conection_handle,
     ...
     */
    void rssi_update(uint16_t conection_handle, int8_t rssi_dBm) override {};
    ...
    void phy_update_request(
        ...
        ble::gap::phy_layer_parameters phy_rx_preferred) override {};
     ...
     */
    void phy_update(uint16_t conection_handle,
                    ble::hci::error_codes status,
                    ble::gap::phy_layer_parameters phy_tx,
                    ble::gap::phy_layer_parameters phy_rx) override {};
     ...
     */
    void link_layer_update_request(uint16_t conection_handle,
                                   uint16_t tx_length_max,
                                   uint16_t rx_length_max,
                                   uint16_t tx_interval_usec_max,
                                   uint16_t rx_interval_usec_max) override {};
     ...
     *                             link later PDU to be received.
     */
    void link_layer_update(uint16_t conection_handle,
                           uint16_t tx_length_max,
                           uint16_t rx_length_max,
                           uint16_t tx_interval_usec_max,
                           uint16_t rx_interval_usec_max) override {};
     ...
     *                         dropped.
     */
    void disconnect(uint16_t conection_handle,
                    ble::hci::error_codes error_code) override {};
     ...
     */
    void connection_security_update(uint16_t conection_handle,
     ...
     */
    void connect(uint16_t conection_handle,
                 ble::gap::address const &peer_address,
     ...
     *                         in bytes.
     */
    void advertising_report(uint16_t conection_handle,
                            ble::gap::address const &peer_address,
                            ble::gap::address const &direct_address,
                            int8_t rssi_dBm, bool scan_response,
                            void const *data, uint8_t data_length) override {};
};
